...
*/
var filteredBob = purchases.filter(obj => obj.owner === "Bob");
console.log(filteredBob);
let bobsTotal = filteredBob.reduce((value, element) => value + element.price,0);

// let bobspurchases = purchases.filter(object => object.owner === "Bob");
// console.log(bobspurchases);
// let bobsTotal = bobspurchases.reduce(
//   (value, purchase) => value + purchase.price,
//   0
// );
